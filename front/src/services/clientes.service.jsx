...
export function useClientesService(){
    ...
    const deleteCliente = (idCliente) => call("/clientes/" + idCliente, "DELETE")

    return { getClientes, getClienteById, createCliente, getProyectosByCliente, updateCliente, deleteCliente }
}
